...
public class LinkedListControlPanel extends JPanel {
    ...
    private static final Color BG_COLOR = new Color(20, 15, 30);
    private static final Color PANEL_BG = new Color(35, 25, 50);
    private static final Color ACCENT = new Color(255, 100, 150);
    private static final Color TEXT_COLOR = new Color(220, 200, 240);
    private static final Color BUTTON_BG = new Color(45, 35, 60);
