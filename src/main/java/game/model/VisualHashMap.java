...
public class VisualHashMap {
    ...
    public synchronized Object put(Object key, Object value, String keyType, String valueType) {
        ...
        lastOperation = "PUT: " + key + " -> " + value + " (bucket[" + bucketIndex + "])";
    ...
    public MemoryInfo getMemoryInfo() {
        ...
        long totalUsed = hashMapOverhead + tableOverhead + nodesOverhead + keysMemory + valuesMemory;

        return new MemoryInfo(totalUsed, hashMapOverhead, tableOverhead, nodesOverhead, keysMemory, valuesMemory);
    }
